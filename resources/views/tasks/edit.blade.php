            ...
            <div class="card-body">
                ...
                <form action="{{ route('tasks.update', $task->id) }}" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Task Update</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="helperText" class="form-control" name="title" value="{{ $task->title }}">
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" id="helperText" class="form-control datetime" placeholder="Due date" name="due_date" value="{{ $task->due_date }}">
                                        @error('due_date')
                                        <div class="text-danger mt-2">
                                            {{ $message }}
                                        </div>
